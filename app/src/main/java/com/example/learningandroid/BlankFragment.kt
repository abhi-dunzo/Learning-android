...
//
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        Log.d("Fragment State ","Hi from onCreate() fragment1")
    ...
    override fun onStart() {
        super.onStart()
        Log.d("Fragment State ","Hi from onStart fragment1")
    }
    override fun onResume() {
        super.onResume()
        Log.d("Fragment State ","Hi form onResume fragment1")
    }
    ...
    override fun onCreateView(
        ...
        Log.d("Fragment State ","Hi from onCreateView() fragment1")
